...
FW:SetMainCategory(FWL.SUMMON_ASSISTANT,FW.ICON.SU,8,"SUMMON","FWSUFrame");
	...
	FW:SetSubCategory(FWL.BAR_COLORING,FW.ICON.FILTER,5);	
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.PLAYER_FAR,		"",	"SummonFarColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.PLAYER_CLOSE,		"",	"SummonCloseColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.BEING_SUMMONED,	"",	"SummoningColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.WHISPERED,		"",	"WhisperColor");

	FW:SetSubCategory(FWL.APPEARANCE,FW.ICON.APPEARANCE,6);	
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.BAR_TEXT,			"",	"SummonTextColor",	SU_SummonShow);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.FRAME_BACKGROUND,	"",	"SummonBgColor",		SU_SummonShow);
