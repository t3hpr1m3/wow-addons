...
L["Adds a bar indicating how much time is left on your mushrooms."] = "Fügt eine Leiste für die übrige Zeit eurer Pilze hinzu." -- Needs review
...
L["Adds rune bars and timers before runes refresh to the player frame."] = "Fügt eine Runenleiste sowie ein Timer, bevor diese Aktualisiert werden, zum Spielerfenster hinzu." -- Needs review
...
L["Health bar color used as the transitional color for 100% -> 0% on players, as well as when your pet is mildly unhappy."] = "Übergangsfarbe, die benutzt wird für die Lebensanzeige von 100% auf 0% beim Spieler und wenn der Begleiter etwas unglücklich ist" -- Needs review
L["Health bar color used as the transitional color for 100% -> 50% on players, as well as when your pet is happy."] = "Übergangsfarbe, die benutzt wird für die Lebensanzeige von 100% auf 50% beim Spieler und wenn der Begleiter glücklich ist" -- Needs review
L["Health bar color used as the transitional color for 50% -> 0% on players, as well as when your pet is very unhappy."] = "Übergangsfarbe, die benutzt wird für die Lebensanzeige von 50% auf 0% beim Spieler und wenn der Begleiter sehr glücklich ist" -- Needs review
...
L["Hide in <=5-man raids"] = "Verstecke in <=5-man Schlachtzügen" -- Needs review
L["Hide in >5-man raids"] = "Verstecke in >5-man Schlachtzügen" -- Needs review
...
L["Holy power"] = "Heilige Kraft" -- Needs review
L["Hostile"] = "Feind"
...
L["How much of the frames total height this bar should get, this is a weighted value, the higher it is the more it gets."] = "Der Anteil vom Fenster der von der Leiste eingenommen wird. Dieser Wert ist gewichtet, um so höher der Wert desto größer die Leiste." -- Needs review
...
L["Monochrome"] = "Monochrom" -- Needs review
L["Moonkin"] = "Moonkin"
L["Mushroom bar"] = "Pilz Leiste" -- Needs review
...
L["Phase status"] = "Phasen Status" -- Needs review
L["Player"] = "Spieler"
...
L["Primary means of coloring the health bar, color on aggro and color by reaction will override this if necessary."] = "Primär bedeutet, das das Einfärben der Gesundheitsleiste, Farbe bei Aggro und Farbe bei Reaktion überschrieben wird, wenn dies erforderlich ist." -- Needs review
...
L["Raid frames are hidden while in a raid group with 5 or less people inside."] = "Schlachtzugsfenster sind versteckt in einer Gruppe mit 5 oder weniger Mitgliedern." -- Needs review
...
L["Resources"] = "Quellen"
L["Resurrect status"] = "Wiederbelebungs Status" -- Needs review
...
L["Scale"] = "Skalierung"
L["Scale for auras that you casted or can Spellsteal, any number above 100% is bigger than default, any number below 100% is smaller than default."] = "Vergrößerung für eigene oder raubbare Auren. Werte über 100% sind größer als Standard, Werte kleiner als 100% sind kleiner als Standard." -- Needs review
L["Scaled aura size"] = "Vergrößerte Auren Größe" -- Needs review
...
L["Total number of active holy power."] = "Anzahl der aktiven heiligen Kraft." -- Needs review
L["Total number of active soul shards."] = "Anzahl der aktiven Seelensplitter" -- Needs review
