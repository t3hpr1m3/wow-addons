...
L["Primary means of coloring the health bar, color on aggro and color by reaction will override this if necessary."] = "Wichtigere Vorgänge, die die Farbe des Lebensbalkens bei Bedrohung und Reaktion verändern überschreiben dies, falls notwendig."
...
L["Shows a bar for alternate power info (used in some encounters)"] = "Zeigt eine Leiste zur Anzeige alternierender Energie (benutzt in einigen Kämpfen)"
