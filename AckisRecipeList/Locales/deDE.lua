...
L["\"Chef\" Overheat"] = "\"Koch\" Gluthitze" -- Needs review
...
L["ARCH_DROP_ULD"] = "Dieses Rezept kann zufällig aus dem Tol'vir Artefakt \"Kanope\" erbeutet werden, das man durch Archäologie erhält." -- Needs review
...
L["BUGGED"] = "DIESES REZEPT VERHÄLT SICH DERZEIT FEHLERHAFT AUF DEN AKTUELLEN SERVERN"
L["Bael'dun Officer"] = "Offizier von Bael'dun" -- Needs review
L["Bael'dun Rifleman"] = "Scharfschütze von Bael'dun" -- Needs review
L["Bael'dun Soldier"] = "Soldat von Bael'dun" -- Needs review
L["Banalash"] = true
L["Barien"] = true
...
L["Buckslappy"] = "Bockschlaps" -- Needs review
L["Burbik Gearspanner"] = "Burbik Ritzelspann"
L["Burko"] = true
L["Buzzek Bracketswing"] = "Buzzek Pratzenschwing"
L["Byancie"] = true
L["CATA_WOW_DESC"] = "Mit Cataclysm verfügbare Rezepte"
...
L["DIG_STEW"] = [=[Horde - Töte Scharfschützen/Soldaten/Offiziere von Bael'dun.
Allianz - Töte Räuber der Ausgrabungsstätte imd Südlichen Brachland.]=] -- Needs review
L["DISCOVERY_ALCH_BC_XMUTE"] = "Entdeckt beim Transmutieren, unter Verwendung von Reagenzien aus Burning Crusade oder höher." -- Needs review
...
L["Eunice Burch"] = true
L["Excavation Raider"] = "Räuber der Ausgrabungsstätte" -- Needs review
...
L["FILTERING_CATA_DESC"] = "Konfiguration die Cataclysm-Rezepte über Ruf-Belohnungen in den Scan einbezieht."
...
L["FIRELANDS_RANDOM"] = "Zufällige Beute von Bossen der Feuerlande." -- Needs review
...
L["Gizzik Oregrab"] = "Gizzik Erzgriff" -- Needs review
...
L["Jillian Tanner"] = "Jillian Gerber" -- Needs review
...
L["LORE_NORTH"] = "Du kannst dieses Rezept erlernen, sobald man den Erfolg \"Dungeonmeister von Nordend\" erlangt hat."
L["Lady Alistra"] = true
L["Laida Gembold"] = true -- Needs review
...
L["Lizna Goldweaver"] = "Lizna Goldflechter" -- Needs review
L["Location"] = "Ort"
L["Logannas"] = true
...
L["Mrs. Gant"] = "Frau Gant" -- Needs review
L["Muaat"] = true
L["Mudduk"] = true
...
L["Mycah"] = true
L["Mythrin'dir"] = true
L["NAXX40_GONE"] = "Wurde aus dem Spiel entfernt, als die 40er-Version von Naxxramas aus dem Spiel entfernt wurde."
L["NECKLACE_DESC"] = "Rezepte, welche Halsketten erstellen, sollen im Scan angezeigt werden."
L["NORTH_DUNG"] = "Du kannst dieses Rezept erlernen, sobald man den Erfolg \"Dungeonmeister von Nordend\" erlangt hat."
...
L["Paku Cloudchaser"] = "Paku Wolkenjäger " -- Needs review
L["Palehoof's Big Bag of Parts"] = "Bleichhufs großer Ersatzteilbeutel" -- Needs review
...
L["Poranna Snowbraid"] = "Poranna Schneezopf" -- Needs review
...
L["Sara Lanner"] = "Paku Wolkenjäger" -- Needs review
...
L["Tari'qa"] = true
L["Tarien Silverdew"] = "Tarien Silbertau" -- Needs review
L["Tatiana"] = true
L["Taur Stonehoof"] = "Taur Steinhuf" -- Needs review
...
L["Vivianna"] = true
L["Vizna Bangwrench"] = "Vizna Schlagzang" -- Needs review
L["Vizzklick"] = true
...
L["Zarrin"] = true
L["Zebig"] = true
L["Zido Helmbreaker"] = "Zido Helmbrecher" -- Needs review
L["Zixil"] = true
