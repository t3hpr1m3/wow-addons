...
L["Disable the text that displays the spell name"] = "주문 이름의 문자 표시를 하지않습니다."
...
L["Only in Instances"] = "인던만 사용"
L["Only show the casts of enemys when inside an instance (dungeon or raid)"] = "인던(던전 & 공격대)시에만 적 시전을 표시합니다."
...
L["Select where to anchor the bars"] = "바 앵커 위치를 선택합니다."
...
L["Set the alpha of the bars"] = "바 투명도 설정합니다."
...
L["Set the color of the bars for undispellable debuffs"] = "해제할 수 없는 디버프에 대한 바의 색상을 설정합니다."
...
L["Set the color the cast bar is changed to when you have a spell interrupted"] = "주문이 차단되었을 때 변경할 시전바의 색상을 설정합니다."
...
L["Set the font size for the bars"] = "바 글꼴 사이즈를 설정합니다."
...
L["Set the grow direction of the bars"] = "바의 설정 방향을 설정합니다."
...
L["Set the side of the bar that the icon appears on"] = "바에 사용할 아이콘의 위치를 설정합니다."
...
L["Show icons on the bars"] = "바 아이콘을 표시합니다."
...
L["Tweak the horizontal position of the bars"] = "바의 가로 위치를 설정합니다."
L["Tweak the horizontal position of the bars for your %s"] = "당신의 %s에 대한 바의 수평 위치를 조절합니다."
L["Tweak the space between bars"] = "바 사이의 간견을 설정합니다."
L["Tweak the space between bars for your %s"] = "당신의 %s에 대한 바 사이의 간격을 설정합니다."
L["Tweak the vertical position of the bars"] = "바의 세로 위치를 설정합니다."
L["Tweak the vertical position of the bars for your %s"] = "당신의 %s에 대한 바의 수직 위치를 조절합니다."
L["Tweak the vertical position of thebars"] = "바의 세로 위치를 설정합니다."
L["Undispellable Color"] = "해재할 수 없는 색상"
