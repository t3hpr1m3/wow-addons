...
L["Disable the text that displays the spell name"] = "Deaktiviert den Text, welcher den Zaubernamen/Rang anzeigt."
...
L["Enemy CastBars"] = "Feindliche Zauberleiste"
...
L["Only show the casts of enemys when inside an instance (dungeon or raid)"] = "Zeige die Zauber der Feinde nur in Instanzen (Dungeons oder Raids)"
...
L["Set the alpha of the bars"] = "Setze die Transparenz der Leisten"
...
L["Set the alpha of the no interrupt casting bar border"] = "Setze die Transparenz des nicht unterbrechbaren Zauberleisterahmen"
...
L["Set the side of the bar that the icon appears on"] = "Bestimme die Seite auf welcher das Icon angezeigt werden soll"
...
L["Set the width of the bars"] = "Bestimme die weite der Leisten"
...
L["Show icons on the bars"] = "Zeige Icons an den Leisten"
...
L["Toggle bar lock"] = "Wechsel Leistensperre"
