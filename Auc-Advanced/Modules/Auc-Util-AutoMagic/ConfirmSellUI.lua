--[[
	...
	Revision: $Id: ConfirmSellUI.lua 5173 2011-06-01 10:08:40Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.13/Auc-Util-AutoMagic/ConfirmSellUI.lua $", "$Rev: 5173 $")
