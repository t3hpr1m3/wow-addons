--[[
	...
	Revision: $Id: PriceLevel.lua 5241 2011-11-30 19:05:41Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.13/Auc-Util-PriceLevel/PriceLevel.lua $", "$Rev: 5241 $")
