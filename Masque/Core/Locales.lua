...
L["Addons"] = "按钮" -- Needs review
L["Adjust the skin of all buttons registered to %s. This will overwrite any per-group settings."] = "将皮肤应用到所有已注册到%s的按钮上。这会覆盖所有群组的设定。" -- Needs review
L["Adjust the skin of all buttons registered to %s: %s."] = "将皮肤应用到所有已注册到%s:%s的按钮上。" -- Needs review
L["Adjust the skin of all registered buttons. This will overwrite any per-add-on settings."] = "将皮肤应用到所有已注册的按钮上。这会覆盖所有插件的设定。" -- Needs review
L["Backdrop Settings"] = "背景设置"
L["Causes Masque to preload its options instead of having them loaded on demand."] = "让Masque预载入其选项，而不是需要的时候才载入。" -- Needs review
L["Causes Masque to throw Lua errors whenever it encounters a problem with an add-on or skin."] = "无论何时Masque遇到了一个插件问题或者皮肤问题，都让其屏蔽Lua错误。" -- Needs review
L["Checked"] = "已选中" -- Needs review
L["Click this button to load Masque's options. You can also use the %s or %s chat command."] = "单击这个按钮来载入Masque的选项。你也可以使用%s或%s命令来实现。" -- Needs review
L["Click to open Masque's options window."] = "点击打开 Masque 选项窗口。" -- Needs review
L["Color"] = "颜色"
L["Colors"] = "颜色"
L["Debug Mode"] = "调试模式" -- Needs review
L["Disable"] = "禁用" -- Needs review
L["Disable the skinning of this group."] = "禁用此群组换肤。" -- Needs review
L["Disabled"] = "已禁用" -- Needs review
L["Enable"] = "启用"
-- L["Enable fonts provided by skins."] = ""
L["Enable the backdrop texture."] = "启用背景材质。" -- Needs review
L["Enable the minimap icon."] = "启用小地图图标。" -- Needs review
L["Flash"] = "闪光" -- Needs review
L["Global"] = "全局" -- Needs review
L["Gloss Settings"] = "光泽设置" -- Needs review
L["Highlight"] = "高亮" -- Needs review
L["Load Masque Options"] = "载入Masque选项" -- Needs review
L["Loading Masque Options..."] = "Masque选项载入中……" -- Needs review
L["Masque debug mode disabled."] = "Masque调试模式禁用。" -- Needs review
L["Masque debug mode enabled."] = "Masque调试模式启用。" -- Needs review
L["Masque is a dynamic button skinning add-on."] = "Masque是一款模块化插件换肤引擎。" -- Needs review
L["Minimap Icon"] = "小地图图标" -- Needs review
L["Normal"] = "正常" -- Needs review
L["Opacity"] = "不透明度"
L["Preload Options"] = "预载入选项" -- Needs review
L["Profiles"] = "配置文件"
L["Pushed"] = "加粗" -- Needs review
L["Reset Skin"] = "重置全部颜色" -- Needs review
L["Reset all skin options to the defaults."] = "重置所有颜色为默认。" -- Needs review
L["Set the color of the backdrop texture."] = "设置背景材质颜色" -- Needs review
L["Set the color of the checked texture."] = "设置已选中材质颜色。" -- Needs review
L["Set the color of the disabled texture."] = "设置已禁用材质颜色。" -- Needs review
L["Set the color of the flash texture."] = "设置闪光材质颜色。" -- Needs review
L["Set the color of the gloss texture."] = "设置光晕材质颜色。" -- Needs review
L["Set the color of the highlight texture."] = "设置高亮材质颜色。" -- Needs review
L["Set the color of the normal texture."] = "设置一般材质颜色。" -- Needs review
L["Set the color of the pushed texture."] = "设置加粗材质颜色。" -- Needs review
L["Set the intensity of the gloss color."] = "设置光泽颜色亮度。" -- Needs review
L["Set the skin for this group."] = "为此群组设置皮肤。" -- Needs review
L["Skin"] = "皮肤"
L["This section will allow you to skin the buttons of the add-ons and add-on groups registered with Masque."] = "这个部分将允许你将使用Masque注册的插件与插件群组的按钮进行换肤。" -- Needs review
L["ToC/A dynamic button skinning add-on."] = "一个模块化的皮肤插件." -- Needs review

	elseif LOC == "zhTW" then
L["Addons"] = "插件"
L["Adjust the skin of all buttons registered to %s. This will overwrite any per-group settings."] = "調整按鈕皮膚註冊到%s。這會覆蓋所有群組的設定。"
L["Adjust the skin of all buttons registered to %s: %s."] = "調整所有按鈕皮膚註冊到%s：%s。"
L["Adjust the skin of all registered buttons. This will overwrite any per-add-on settings."] = "調整所有已註冊按鈕的皮膚。這會覆蓋所有的插件設定。"
...
L["Causes Masque to throw Lua errors whenever it encounters a problem with an add-on or skin."] = "每當遭遇插件或是皮膚問題都會讓Masque丟出Lua錯誤。"
L["Checked"] = "已勾選"
...
L["Debug Mode"] = "除錯模式"
L["Disable"] = "禁用"
L["Disable the skinning of this group."] = "禁用群組的皮膚。"
L["Disabled"] = "已禁用"
L["Enable"] = "啟用"
L["Enable fonts provided by skins."] = "啟用由皮膚提供的字型。"
...
L["Loading Masque Options..."] = "正載載入Masque設定..."
L["Masque debug mode disabled."] = "Masque除錯模式已禁用。"
L["Masque debug mode enabled."] = "Masque除錯模式已啟用。"
L["Masque is a dynamic button skinning add-on."] = "Masque是模組化皮膚插件。"
...
L["Pushed"] = "按下"
L["Reset Skin"] = "重置皮膚"
L["Reset all skin options to the defaults."] = "重置所有皮膚為預設值。"
...
L["Set the skin for this group."] = "設定群組皮膚。"
L["Skin"] = "皮膚"
L["This section will allow you to skin the buttons of the add-ons and add-on groups registered with Masque."] = "這部分允許你扒掉插件按鈕皮膚且被Masque註冊插件群組。"
L["ToC/A dynamic button skinning add-on."] = "模組化按鈕皮膚插件。"
