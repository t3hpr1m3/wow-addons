...
local function ColorVal(frame,flag,spell,custom)
	if custom == FILTER_COLOR or custom == FILTER_SHOW_COLOR then
		...
		return unpack(frame.s[ types[flag] ]); -- default colors
	end
end
...
function CD:RegisterMeleePowerupCooldowns()
	...
	CD:RegisterCooldownPowerup(59515,92213); -- Vial of Stolen Memories, Memory of Invincibility
	...
	CD:RegisterHiddenCooldown(61046,85032,45); -- Vicious Gladiator's Insignia of Victory, Surge of Victory
	CD:RegisterHiddenCooldown(68994,96977,105); -- Matrix Restabilizer, Matrix Restabilized
	CD:RegisterHiddenCooldown(68927,96911,60); -- The Hungerer, Devour
...
function CD:RegisterCasterPowerupCooldowns()
	...
	CD:RegisterCooldownPowerup(70142,100403); -- Moonwell Chalice, Blessing of the Moonwell
	...
	CD:RegisterHiddenCooldown(56320,90887,75); -- Witching Hourglass, Witching Hour
	CD:RegisterHiddenCooldown(59500,91184,75); -- Fall of Mortality, Grounded Soul
...
FW:SetMainCategory(FWL.COOLDOWN_TIMER,FW.ICON.CD,4,"COOLDOWN",nil,"Cooldown");
	...
	FW:SetSubCategory(FWL.BASIC,FW.ICON.BASIC,2,FW.EXPAND);
		...
		FW:RegisterOption(FW.CHK,1,FW.NON,FWL.FLIP_BAR,		FWL.FLIP_BAR_TT,		"Flip",			CD_CooldownShow);
		FW:RegisterOption(FW.CHK,1,FW.NON,FWL.CD_SPECIFIC3,	FWL.CD_SPECIFIC3_TT,	"Hide");
		FW:RegisterOption(FW.CHK,1,FW.NON,FWL.TIMER_HIDE,	FWL.TIMER_HIDE_TT,		"HideCombat");
	...
	FW:SetSubCategory(FWL.SPECIFIC,FW.ICON.SPECIFIC,3);
		...
		FW:RegisterOption(FW.CHK,1,FW.NON,FWL.ICON_TEXT,	FWL.ICON_TEXT_TT,		"IconTime",	CD_CooldownShow);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.ICON_TEXT_COLOR,FWL.ICON_TEXT_COLOR_TT,"IconTextColor",CD_CooldownShow,nil,nil,"IconTime");
		FW:RegisterOption(FW.FNT,2,FW.NON,FWL.ICON_FONT,	FWL.ICON_TEXT_TT,		"IconFont",	CD_CooldownShow,nil,nil,"IconTime");
	
	FW:SetSubCategory(FWL.CD_SPLASH,FW.ICON.GLOW,3);
		FW:RegisterOption(FW.CHK,1,FW.NON,FWL.CD_SPLASH1,	FWL.CD_SPLASH1_TT,		"Splash");
		FW:RegisterOption(FW.NUM,1,FW.NON,FWL.CD_SPLASH2,	FWL.CD_SPLASH2_TT,		"SplashFactor",nil,1,nil,"Splash");
	...
	FW:SetSubCategory(FWL.TIME_RANGE,FW.ICON.TIME,4);	
		...
		FW:RegisterOption(FW.NUM,1,FW.NON,FWL.NUM_TIME_TAGS,FWL.NUM_TIME_TAGS_TT,	"Tags",			CD_CooldownShow,2,nil,"not CustomTags");
	...
	FW:SetSubCategory(FWL.MY_COOLDOWNS,FW.ICON.FILTER,5,nil,FW.REDUCED_ALPHA);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.SPELL,				"",	"SpellColor",				CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.PET,					"",	"PetColor",					CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.ITEM,					"",	"ItemColor",				CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.POWERUP,				"",	"PowerupColor",				CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.POTION,				"",	"PotionColor",				CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.HEALTHSTONE_NORMAL,	"",	"HealthstoneColor",			CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.SS,					"",	"SoulstoneColor",			CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.RESURRECT_TIMER,		"",	"ResTimerColor",			CD_CooldownFilterChange);
	
	FW:SetSubCategory(FWL.BUFFS_DEBUFFS_ON_ME,FW.ICON.FILTER,5,nil,FW.REDUCED_ALPHA);	
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.BUFF,			FWL.CD_SPECIFIC7_TT,	"BuffColor", 		CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.ALL_OTHER_BUFFS,		"",				"BuffOtherColor", 	CD_CooldownFilterChange,nil,nil,false);	
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.DEBUFF,				"",				"DebuffColor", 		CD_CooldownFilterChange);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.ALL_OTHER_DEBUFFS,	"",				"DebuffOtherColor",	CD_CooldownFilterChange,nil,nil,false);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.WEAPON_ENCHANT,		"",				"EnchantColor", 	CD_CooldownFilterChange);
	...
	FW:SetSubCategory(FWL.APPEARANCE,FW.ICON.APPEARANCE,7);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.BAR,					"",			"BarColor",		CD_CooldownShow);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.FRAME_BACKGROUND,		"",			"BgColor",		CD_CooldownShow);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.BAR_TEXT,				"",			"TextColor",	CD_CooldownShow);
...
FW:SetMainCategory(FWL.SECONDARY_SPLASH,FW.ICON.CD,4,"COOLDOWN",nil,"Splash");
	FW:SetSubCategory(FWL.GENERAL_TIPS,FW.ICON.HINT,1);
	...
	FW:SetSubCategory(FWL.SPECIFIC,FW.ICON.SPECIFIC,3);
		FW:RegisterOption(FW.NUM,1,FW.NON,FWL.CD_SPLASH2,	FWL.CD_SPLASH2_TT,	"SecondSplashMax",nil,0.1);
...
FW.InstanceDefault.Cooldown = {
	...
	PotionColor =		{[0]=true,0.00,1.00,0.00},
	HealthstoneColor =	{[0]=true,0.00,1.00,0.50},
	SpellColor = 		{[0]=true,1.00,0.50,0.00},
	PetColor = 			{[0]=true,1.00,0.00,0.95},
	PowerupColor =		{[0]=true,0.00,0.75,1.00},
	ItemColor =			{[0]=true,1.00,1.00,0.00},
	ResTimerColor =		{[0]=true,1.00,0.00,0.00},
	BuffColor =			{[0]=true,1.00,1.00,1.00},
	BuffOtherColor =	{[0]=false,0.50,0.50,0.50},
	DebuffColor =		{[0]=true,1.00,0.00,0.00},
	DebuffOtherColor =	{[0]=false,0.50,0.00,0.00},
	EnchantColor =		{[0]=true,1.00,1.00,1.00},
	SoulstoneColor =	{[0]=true,0.64,0.21,0.93},
