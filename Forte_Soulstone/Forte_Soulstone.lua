...
local function SS_SetSSButton()
	...
	if not STATES.INCOMBAT then -- update the use function in case it wasnt loaded properly due to combat or whatever
...
FW:SetMainCategory(FWL.SOULSTONE_TRACKER,FW.ICON.SS,5,"SOULSTONE","FWSSFrame");
	...
	FW:SetSubCategory(FWL.BAR_COLORING,FW.ICON.FILTER,5);	
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.SS_FULL,				"",	"SoulstoneMaxColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.SS_EMPTY,				"",	"SoulstoneMinColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.RESURRECT,			"",	"ReadyColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.DEAD,					"",	"DeadColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.OFFLINE,				"",	"OfflineColor");
		FW:RegisterOption(FW.NUM,1,FW.NON,FWL.DEAD_OFFLINE_MIXING,	FWL.DEAD_OFFLINE_MIXING_TT,	"Mix",nil,0,1);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.WARLOCK,				"",	"WarlockColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.DRUID,				"",	"DruidColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.PALADIN,				"",	"PaladinColor");
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.SHAMAN,				"",	"ShamanColor");

	FW:SetSubCategory(FWL.APPEARANCE,FW.ICON.APPEARANCE,6);	
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.BAR_TEXT,			"",	"SoulstoneTextColor",	SS_SoulstoneShow);
		FW:RegisterOption(FW.COL,1,FW.NON,FWL.FRAME_BACKGROUND,	"",	"SoulstoneBgColor",		SS_SoulstoneShow);
...
FW:SetMainCategory(FWL.SELF_MESSAGES);
	FW:SetSubCategory(FWL.SOULSTONE_TRACKER,FW.ICON.BASIC,2);
		FW:RegisterOption(FW.CO2,1,FW.NON,FWL.SOULSTONE_MESSAGES_COLOR,		FWL.SHOW_SOULSTONE_MESSAGES_TT,"SoulstoneMsgColor");
