...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	["A module to play sounds on certain chat messages."] = "특정 채팅 메시지에 소리 재생 모듈.",
	["Add a custom channel"] = "사설 채널 추가",
	["Custom Channels"] = "사설 채널",
	["Incoming Sounds"] = "들어오는 소리",
	["Outgoing Sounds"] = "나가는 소리",
	...
	["Sound selection for incoming chat messages"] = "들어오는 채팅 메시지의 소리 선택",
	["Sound selection for outgoing (from you) chat messages"] = "나가는 (당신으로 부터) 채팅 메시지의 소리 선택",
	Sounds = "소리",
